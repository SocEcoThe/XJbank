...
public class MultiCurrencyPlugin extends CommonPlugin {
    ...
    public void onEnable() {
        ...
        try (Connection connection = hikari.getConnection()) {
            String[] create = {
                    "CREATE TABLE IF NOT EXISTS `mc_account` (`id` INT (11) NOT NULL AUTO_INCREMENT,`username` VARCHAR (50) NOT NULL COMMENT '存款人',`code` CHAR (3) NOT NULL COMMENT '货币代码',`balance` DECIMAL (16,6) NOT NULL DEFAULT 0.000000 COMMENT '账户余额',PRIMARY KEY (`id`),UNIQUE KEY `username_code` (`username`,`code`)) ENGINE=INNODB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='存款账户表';",
